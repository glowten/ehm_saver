...
def enum_return(hwnd, _):
    global ehmWindow
    if 'eastside hockey manager' in win32gui.GetWindowText(hwnd).lower():
        ehmWindow = hwnd
    return True

# ethernet_command = 'netsh interface set interface "Ethernet 4"'
#
# def yeet_ethernet():
#     subprocess.run(ethernet_command + 'disabled')
#
# def unyeet_ethernet():
